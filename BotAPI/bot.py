...
f=open( 'D:\Python\Python39\AutoQA\BotAPI\\NLPfiles\\Nlp python answer finals.txt', 'r', errors ='ignore' )
m=open( 'D:\Python\Python39\AutoQA\BotAPI\\NLPfiles\modules pythons.txt', 'r', errors ='ignore' )
...
Introduce_Ans = ["My name is AutoQA AI.","My name is AutoQA AI you can called me pi.","Im AutoQA AI :) ","My name is AutoQA AI. and my nickname is pi and i am happy to solve your queries :) "]
...
Basic_AnsM = ["A module can define functions, classes and variables and module can also include runnable code."]
